...
- Tasks 1–34, 38–52, **53 (Писање Tracing game)**, **54 (tools/ tooling)**, and **43 (alphabet pronunciation/image audit)** are DONE. Tasks 35/36 (stickers + screen transitions) are **deferred to a later phase**.
